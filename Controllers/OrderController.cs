...
namespace Autoservice_Back.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        [HttpPost("Edit")]
        public IActionResult Edit([FromBody] OrderResult orderResult, [FromServices] IOrders reposOrders)
        {
            reposOrders.EditOrder(orderResult.Result, orderResult.CLient_Id, orderResult.Id);
            return Ok();
